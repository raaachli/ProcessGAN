...
def save_act_dif_figure(frequency_dict, save_path):
    ...
    # plt.xticks([r + barWidth for r in range(len(bars1))], my_df['activity'])
...
if __name__ == '__main__':
    aut_path = 'data/data_all/data_seq/INT.txt'
    seq_path = 'results/result_seq/INT/162142_lstm/result_lstm.txt'
    save_path = 'data_2'
